...
<body>
  <h1>Cover Letter</h1>
  <div class="content">
    ${paragraphs || '<p class="paragraph">Dear Hiring Manager,</p><p class="paragraph">Please find attached my application for the target role.</p><p class="paragraph">Sincerely,<br>Candidate</p>'}
  </div>
</body>
</html>`;
}
